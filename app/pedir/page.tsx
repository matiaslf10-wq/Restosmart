...
export default function PedirPage() {
  ...
  const businessModeLabel = formatBusinessModeLabel('takeaway');
    ...
    try {
      ...
      setMensaje(
        formaPago === 'efectivo'
          ...
          : `Pedido #${pedido.id} generado correctamente. Quedó enviado a cocina para take away.`
      );
    } catch (err) {
      console.error(err);
      setError(
