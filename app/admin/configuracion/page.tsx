...
>
  ...
  <section className="rounded-2xl border bg-white p-5 shadow-sm">
    <div className="flex flex-wrap items-start justify-between gap-3">
      <div>
        <h2 className="text-lg font-medium">QR públicos de take away</h2>
        <p className="mt-1 text-sm text-neutral-600">
          Cada sucursal tiene sus propios enlaces públicos. El QR de pedido abre{' '}
          <code>{buildPublicPedirHref()}</code> y la pantalla de retiro abre{' '}
          <code>{buildPublicRetiroHref()}</code>.
        </p>
      </div>
    ...
    <div className="mt-4 grid gap-4 xl:grid-cols-2">
      ...
      <TakeAwayQrCard
        localName={localForm.nombre_local || 'RestoSmart'}
        routePath={buildPublicRetiroHref()}
        title="QR de pantalla de retiro"
        description="Escaneá este código para abrir la pantalla pública donde se muestran los pedidos en preparación y listos para retirar de esta sucursal."
        badgeLabel="PANTALLA RETIRO"
      />
    </div>
    ...
    <div className="mt-4 rounded-2xl border border-slate-200 bg-slate-50 p-4">
      ...
      <div className="mt-3 space-y-3 text-sm leading-relaxed text-slate-700">
        <p>
          <span className="font-medium">QR de pedido:</span> pegado en el
          mostrador, vidriera, caja o mesa de retiro para que el cliente cargue
          su pedido.
        </p>

        <p>
          <span className="font-medium">QR de pantalla de retiro:</span> usalo
          en la tablet, monitor o pantalla visible para clientes. Muestra solo
          los pedidos de esta sucursal.
        </p>

        <p>
          <span className="font-medium">Ruta del pedido:</span>{' '}
          <code>{buildPublicPedirHref()}</code>
        </p>

        <p>
          <span className="font-medium">Ruta de retiro:</span>{' '}
          <code>{buildPublicRetiroHref()}</code>
        </p>
      </div>
